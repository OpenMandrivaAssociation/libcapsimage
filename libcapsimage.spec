...
chmod +x capsimg_source_linux_macosx/CAPSImg/configure \
	capsimg_source_linux_macosx/CAPSImg/config.guess \
	capsimg_source_linux_macosx/CAPSImg/config.sub \
...
cd capsimg_source_linux_macosx/CAPSImg
%make_install
ln -s libcapsimage.so.%{version} %{buildroot}%{_libdir}/libcapsimage.so.5
ln -s libcapsimage.so.5 %{buildroot}%{_libdir}/libcapsimage.so
...
%license LICENCE.txt
%{_libdir}/libcapsimage.so.5
%{_libdir}/libcapsimage.so.%{version}
